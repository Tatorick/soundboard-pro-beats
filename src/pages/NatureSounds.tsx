...
const NatureSounds = () => {
  ...
  const natureSounds = [
    { id: 'rain', name: 'Rain', color: 'from-blue-500 to-blue-600' },
    { id: 'ocean', name: 'Ocean', color: 'from-cyan-500 to-cyan-600' },
    { id: 'forest', name: 'Forest', color: 'from-green-500 to-green-600' },
    { id: 'birds', name: 'Birds', color: 'from-yellow-500 to-yellow-600' },
    { id: 'wind', name: 'Wind', color: 'from-gray-500 to-gray-600' },
    { id: 'river', name: 'River', color: 'from-teal-500 to-teal-600' }
  ];

  const weatherSounds = [
    { id: 'thunder', name: 'Thunder', color: 'from-purple-500 to-purple-600' },
    { id: 'storm', name: 'Storm', color: 'from-indigo-500 to-indigo-600' },
    { id: 'snow', name: 'Snow', color: 'from-blue-300 to-blue-400' },
    { id: 'fire', name: 'Fire', color: 'from-orange-500 to-red-600' },
    { id: 'crickets', name: 'Crickets', color: 'from-emerald-500 to-emerald-600' },
    { id: 'waves', name: 'Waves', color: 'from-blue-400 to-cyan-500' }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="bg-white shadow-sm border-b border-gray-200 px-4 py-4">
        <div className="flex items-center justify-between max-w-4xl mx-auto">
          ...
          <h1 className="text-xl font-bold text-gray-800">Nature Sounds</h1>
      ...
      <div className="p-4 max-w-4xl mx-auto">
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 mb-4 text-center">Nature Sounds</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            {natureSounds.map((sound) => (
              <SoundButton key={sound.id} sound={sound} section="nature" />
            ))}
          </div>
        </div>

        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 mb-4 text-center">Weather Sounds</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            {weatherSounds.map((sound) => (
              <SoundButton key={sound.id} sound={sound} section="weather" />
            ))}
          </div>
        </div>
          ...
          <div className="fixed top-20 left-4 right-4 bg-blue-600 text-white px-4 py-2 rounded-xl shadow-lg z-40 max-w-md mx-auto">
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium">
                Reproduciendo: {natureSounds.concat(weatherSounds).find(s => s.id === playingSound)?.name}
              </span>
